/**
 * The delete function takes an array and an index as input and deletes the element at that index
 *
 * @param input_arr The array that you want to input the elements into.
 */
#include <stdio.h>
#include <stdlib.h>
